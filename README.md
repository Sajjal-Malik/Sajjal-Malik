...
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=django,nodejs,numpy,pandas,matplotlib,seaborn,googleanalytics,vscode,sublime,codepen,chatgpt,gemini,powershell,bash,sqlite,mysql,postgresql,mongodb,windows,linux)
